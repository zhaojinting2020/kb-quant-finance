---
title: An Interview Primer for Quantitative Finance — Dirk Bester (QuantitativePrimer)
source: attachments/imported/quant-books/root-5a9dd3775cc7/a-practical-guide-to-quantitative-finance-interviews.pdf
source_type: PDF
quality: draft
import_mode: A
attachments:
...
Dirk Bester，[QuantitativePrimer](https://github.com/dwcoder/QuantitativePrimer)（CC BY-SA 4.0）。归档索引：原件见下方链接，正文未做 OCR/全文转换。

## 附件

- [[attachments/imported/quant-books/root-5a9dd3775cc7/a-practical-guide-to-quantitative-finance-interviews.pdf|QuantitativePrimer（PDF）]]
